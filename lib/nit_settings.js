module.exports = function NitSettings() {
    ...
    NETTINGS.load = function(){
        ...
        settings.jira.boardName = settings.jira.boardName || NETTINGS.defaultSettings.jira.boardName;
        settings.jira.sprintVelocityJQL = settings.jira.sprintVelocityJQL || NETTINGS.defaultSettings.jira.sprintVelocityJQL;
        settings.jira.issuesInSprintWithStatusJQL = settings.jira.issuesInSprintWithStatusJQL || NETTINGS.defaultSettings.jira.issuesInSprintWithStatusJQL;
        settings.jira.statuses = settings.jira.statuses || NETTINGS.defaultSettings.jira.statuses;
