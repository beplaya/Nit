module.exports = function Printer(){
    ...
    PRINTER.description = function(issueID, data) {
    ...
    PRINTER.printStatus = function(statusData, currentBranch, isDetached) {
        ...
        if(PRINTER.statusStringIsClean(strings, statusData)){
