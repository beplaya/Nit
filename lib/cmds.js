...
return [
           {arg: "help", name: "Help", requiresClean: false, action:            function(nit, arg, currentBranch, statusData, cbAll){ nit.help(); }},
           {arg: "st", name: "Status", requiresClean: false, action:            function(nit, arg, currentBranch, statusData, cbAll){ nit.printStatusData(statusData); }},
           {arg: "sts", name: "Status -s", requiresClean: false, action:        function(nit, arg, currentBranch, statusData, cbAll){ nit.sts(); }},
           {arg: "b", name: "Discover branch", requiresClean: false, action:    function(nit, arg, currentBranch, statusData, cbAll){ nit.onBranch(); }},
           {arg: "l1", name: "'git log --pretty=oneline' with extra Nit formatting", requiresClean: false, action:      function(nit, arg, currentBranch, statusData, cbAll){ nit.logOneLiners(currentBranch); }},
           {arg: "push", name: "Push (assumes origin/<branch>)", requiresClean: true, action:                           function(nit, arg, currentBranch, statusData, cbAll){ nit.push(currentBranch); }},
           {arg: "pull", name: "Pull (assumes origin/<branch>)", requiresClean: false, action:                          function(nit, arg, currentBranch, statusData, cbAll){ nit.pull(currentBranch); }},
