module.exports = function(nit) {
    ...
    var L = {  nit : nit,
        chart : new require(__dirname +"/chart/chart.js")(),
        trailingN : 100,
        statPage : {
            files : {
    ...
    L.getWeeklyMovingAverage = function(dailyMovingAverages) {
        var self = this;
    ...
    L.statEntries = function(entries) {
        ...
        var weeklyMovingAverages = self.getWeeklyMovingAverage(dailyMovingAverage);
